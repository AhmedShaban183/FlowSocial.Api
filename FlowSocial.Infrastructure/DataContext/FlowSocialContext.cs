...
namespace FlowSocial.Infrastructure.DataContext
{
    public class FlowSocialContext:IdentityDbContext<ApplicationUser>
    {
       // public PlatformContext() { }
        public FlowSocialContext(DbContextOptions<FlowSocialContext> options) : base(options) { }
       ...
       public DbSet<Comment> Comments { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
          ...
          .OnDelete(DeleteBehavior.NoAction); // Don't allow deleting a user if they are following someone
